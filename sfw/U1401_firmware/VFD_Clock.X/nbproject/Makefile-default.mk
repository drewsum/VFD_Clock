...
${OBJECTDIR}/heartbeat_requests.o: heartbeat_requests.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/heartbeat_requests.o.d 
	@${RM} ${OBJECTDIR}/heartbeat_requests.o 
	@${FIXDEPS} "${OBJECTDIR}/heartbeat_requests.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/heartbeat_requests.o.d" -o ${OBJECTDIR}/heartbeat_requests.o heartbeat_requests.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/heartbeat_requests.o: heartbeat_requests.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/heartbeat_requests.o.d 
	@${RM} ${OBJECTDIR}/heartbeat_requests.o 
	@${FIXDEPS} "${OBJECTDIR}/heartbeat_requests.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/heartbeat_requests.o.d" -o ${OBJECTDIR}/heartbeat_requests.o heartbeat_requests.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
