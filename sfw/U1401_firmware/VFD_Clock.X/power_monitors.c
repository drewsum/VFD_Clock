...
void printPowerMonitorStatus(void) {
    ...
    terminalTextAttributes(GREEN_COLOR, BLACK_COLOR, BOLD_FONT);
    printf("INA219 Power Monitor, located at 0x%02X\r\n", POS3P3_IN_MON_ADDR);
    INA219printStatus(POS3P3_IN_MON_ADDR, &error_handler.flags.pos3p3_in_mon);
    terminalTextAttributes(GREEN_COLOR, BLACK_COLOR, BOLD_FONT);
    printf("INA219 Power Monitor, located at 0x%02X\r\n", POS3P3_OUT_MON_ADDR);
    INA219printStatus(POS3P3_OUT_MON_ADDR, &error_handler.flags.pos3p3_out_mon);
    terminalTextAttributes(GREEN_COLOR, BLACK_COLOR, BOLD_FONT);
    printf("INA219 Power Monitor, located at 0x%02X\r\n", POS5_IN_MON_ADDR);
    INA219printStatus(POS5_IN_MON_ADDR, &error_handler.flags.pos5_in_mon);
    terminalTextAttributes(GREEN_COLOR, BLACK_COLOR, BOLD_FONT);
    printf("INA219 Power Monitor, located at 0x%02X\r\n", POS5_OUT_MON_ADDR);
    INA219printStatus(POS5_OUT_MON_ADDR, &error_handler.flags.pos5_out_mon);
    terminalTextAttributes(GREEN_COLOR, BLACK_COLOR, BOLD_FONT);
    printf("INA219 Power Monitor, located at 0x%02X\r\n", POS1P2_VFF_IN_MON_ADDR);
    INA219printStatus(POS1P2_VFF_IN_MON_ADDR, &error_handler.flags.pos1p2_vff_in_mon);
    terminalTextAttributes(GREEN_COLOR, BLACK_COLOR, BOLD_FONT);
    printf("INA219 Power Monitor, located at 0x%02X\r\n", POS1P2_VFF_OUT_MON_ADDR);
    INA219printStatus(POS1P2_VFF_OUT_MON_ADDR, &error_handler.flags.pos1p2_vff_out_mon);
    terminalTextAttributes(GREEN_COLOR, BLACK_COLOR, BOLD_FONT);
    printf("INA219 Power Monitor, located at 0x%02X\r\n", POS60_VAN_IN_MON_ADDR);
    INA219printStatus(POS60_VAN_IN_MON_ADDR, &error_handler.flags.pos60_van_in_mon);
    terminalTextAttributes(GREEN_COLOR, BLACK_COLOR, BOLD_FONT);
