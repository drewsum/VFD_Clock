...
F 7 "541-1322-1-ND" H 0   0   50  0001 C CNN "Digi-Key PN"
	1    6410 3420
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
F 7 "75.0KHCT-ND" H 0   0   50  0001 C CNN "Digi-Key PN"
	1    7130 3650
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
F 7 "P150KHCT-ND" H 0   0   50  0001 C CNN "Digi-Key PN"
	1    7130 4010
	-1   0    0    -1  
$EndComp
$Comp
...
U 1 1 5B3339E2
P 7130 4160
F 0 "#PWR0608" H 7130 3910 50  0001 C CNN
...
F 7 "587-1961-1-ND" H 8185 4120 60  0001 C CNN "Digi-Key PN"
	1    7760 3620
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5B3347FF
P 7760 3770
F 0 "#PWR0610" H 7760 3520 50  0001 C CNN
...
$EndComp
$Comp
L Custom-Library:VFF #PWR0609
U 1 1 5B33515C
P 7760 3380
F 0 "#PWR0609" H 7760 3230 50  0001 C CNN
...
U 1 1 5B335F4D
P 5560 4200
F 0 "#PWR0607" H 5560 3950 50  0001 C CNN
...
U 1 1 5B336DDC
P 5100 3770
F 0 "#PWR0606" H 5100 3520 50  0001 C CNN
...
F 7 "399-11138-1-ND" H 4985 4370 60  0001 C CNN "Digi-Key PN"
	1    4560 3870
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5B337796
P 4560 4020
F 0 "#PWR0603" H 4560 3770 50  0001 C CNN
...
U 1 1 5B338212
P 3930 4000
F 0 "#PWR0601" H 3930 3750 50  0001 C CNN
...
F 5 "50V" H 4550 2930 50  0000 R CNN "Voltage"
F 6 "X5R" H 4550 2830 50  0000 R CNN "Dielectric"
F 7 "490-8590-1-ND" H 5125 3430 60  0001 C CNN "Digi-Key PN"
	1    4700 2930
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5B338C29
P 4700 3080
F 0 "#PWR0605" H 4700 2830 50  0001 C CNN
...
$Comp
L Custom-Library:+3.3V #PWR0604
U 1 1 5B339A79
P 4700 2610
F 0 "#PWR0604" H 4700 2460 50  0001 C CNN
...
$EndComp
$Comp
L Custom-Library:+3.3V #PWR0602
U 1 1 5B33A04D
P 3930 4510
F 0 "#PWR0602" H 3930 4360 50  0001 C CNN
...
$Comp
L Custom-Library:VFF #PWR0611
U 1 1 5B3D14B1
P 8240 3380
F 0 "#PWR0611" H 8240 3230 50  0001 C CNN
...
U 1 1 5B3D14D0
P 8240 3380
F 0 "#FLG0601" H 8240 3455 50  0001 C CNN
...
AR Path="/5A0A7E5F/5B5317EC" Ref="TP601"  Part="1" 
F 0 "TP601" H 7370 3530 50  0000 C CNN
