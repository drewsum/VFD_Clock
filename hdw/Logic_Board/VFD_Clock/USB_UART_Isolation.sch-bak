...
AR Path="/5CAD2DA3/5BB15594" Ref="#PWR02518"  Part="1" 
F 0 "#PWR02518" H 6270 1090 50  0001 C CNN
...
U 1 1 5BB167BA
P 4690 1950
F 0 "#PWR02508" H 4690 1700 50  0001 C CNN
...
Wire Wire Line
	4690 1500 5100 1500
$Comp
L Custom_Library:GND_USB #PWR02519
U 1 1 5BB169D6
P 6270 1950
F 0 "#PWR02519" H 6270 1700 50  0001 C CNN
...
AR Path="/5CAD2DA3/5BB17511" Ref="R2501"  Part="1" 
F 0 "R2501" H 3370 1360 50  0000 R CNN
...
AR Path="/5CAD2DA3/5BB17551" Ref="R2502"  Part="1" 
F 0 "R2502" H 4040 1360 50  0000 R CNN
...
AR Path="/5CAD2DA3/5BB1788F" Ref="R2506"  Part="1" 
F 0 "R2506" H 6820 1260 50  0000 R CNN
...
AR Path="/5CAD2DA3/5BB1789A" Ref="R2508"  Part="1" 
F 0 "R2508" H 7510 1260 50  0000 R CNN
...
$EndComp
$Comp
L Custom_Library:C_Custom C2501
U 1 1 5BB18B68
P 4420 2930
F 0 "C2501" H 4445 3030 50  0000 L CNN
...
$EndComp
$Comp
L Custom_Library:C_Custom C2504
U 1 1 5BB18CF0
P 6570 2930
F 0 "C2504" H 6595 3030 50  0000 L CNN
...
U 1 1 5BB18D76
P 4420 3080
F 0 "#PWR02504" H 4420 2830 50  0001 C CNN
...
AR Path="/5CAD2DA3/5BB18EFD" Ref="#PWR02520"  Part="1" 
F 0 "#PWR02520" H 6570 2630 50  0001 C CNN
...
$EndComp
$Comp
L Custom_Library:GND_USB #PWR02521
U 1 1 5BB18F1A
P 6570 3080
F 0 "#PWR02521" H 6570 2830 50  0001 C CNN
...
$EndComp
$Comp
L Custom_Library:C_Custom C2503
U 1 1 5BB19187
P 5500 3130
F 0 "C2503" V 6024 3130 50  0000 C CNN
...
$EndComp
$Comp
L Custom_Library:GND_USB #PWR02515
U 1 1 5BB196CB
P 5950 3200
F 0 "#PWR02515" H 5950 2950 50  0001 C CNN
...
$EndComp
$Comp
L power:GND #PWR02509
U 1 1 5BB196EC
P 5010 3200
F 0 "#PWR02509" H 5010 2950 50  0001 C CNN
...
Wire Wire Line
	5950 3130 5950 3200
$Comp
L Isolator:ISO7321C U2501
U 1 1 5BB4118F
P 5500 1600
F 0 "U2501" H 5500 2025 50  0000 C CNN
...
U 1 1 5BBE892D
P 4420 2780
F 0 "#PWR02503" H 4420 2630 50  0001 C CNN
...
$EndComp
$Comp
L power:+3.3V #PWR02507
U 1 1 5BBE896C
P 4690 1240
F 0 "#PWR02507" H 4690 1090 50  0001 C CNN
...
AR Path="/5CAD2DA3/5BC8FC49" Ref="#PWR02527"  Part="1" 
F 0 "#PWR02527" H 6880 960 50  0001 C CNN
...
AR Path="/5CAD2DA3/5BC8FC74" Ref="#PWR02529"  Part="1" 
F 0 "#PWR02529" H 7570 960 50  0001 C CNN
...
U 1 1 5BC8FCA7
P 4100 1210
F 0 "#PWR02502" H 4100 1060 50  0001 C CNN
...
U 1 1 5BC8FCC2
P 3430 1210
F 0 "#PWR02501" H 3430 1060 50  0001 C CNN
...
Wire Wire Line
	5900 1700 7570 1700
$Comp
L Isolator:ISO1541 U2502
U 1 1 5E070BDE
P 5500 4200
F 0 "U2502" H 5250 4450 50  0000 C CNN
...
U 1 1 5E072B09
P 5020 4480
F 0 "#PWR02511" H 5020 4230 50  0001 C CNN
...
U 1 1 5E073757
P 5020 4020
F 0 "#PWR02510" H 5020 3870 50  0001 C CNN
...
Wire Wire Line
	5020 4100 5100 4100
$Comp
L Custom_Library:GND_USB #PWR02517
U 1 1 5E07437A
P 5980 4480
F 0 "#PWR02517" H 5980 4230 50  0001 C CNN
...
Wire Wire Line
	5980 4400 5900 4400
$Comp
L Custom_Library:+5V_USB #PWR02516
U 1 1 5E075176
P 5980 4020
F 0 "#PWR02516" H 5980 3870 50  0001 C CNN
...
AR Path="/5CAD2DA3/5E078108" Ref="R2505"  Part="1" 
F 0 "R2505" H 6680 3970 50  0000 R CNN
...
AR Path="/5CAD2DA3/5E078112" Ref="R2507"  Part="1" 
F 0 "R2507" H 7260 3970 50  0000 R CNN
...
Wire Wire Line
	5900 4300 6740 4300
$Comp
L Custom_Library:+5V_USB #PWR02526
U 1 1 5E07E764
P 6740 3820
F 0 "#PWR02526" H 6740 3670 50  0001 C CNN
...
$EndComp
$Comp
L Custom_Library:+5V_USB #PWR02528
U 1 1 5E07EB59
P 7320 3820
F 0 "#PWR02528" H 7320 3670 50  0001 C CNN
...
I2C_USB_SDA
$Comp
L Custom_Library:C_Custom C2502
U 1 1 5E091062
P 4420 5170
F 0 "C2502" H 4445 5270 50  0000 L CNN
...
$EndComp
$Comp
L Custom_Library:C_Custom C2505
U 1 1 5E09106C
P 6570 5170
F 0 "C2505" H 6595 5270 50  0000 L CNN
...
$EndComp
$Comp
L power:GND #PWR02506
U 1 1 5E091072
P 4420 5320
F 0 "#PWR02506" H 4420 5070 50  0001 C CNN
...
AR Path="/5CAD2DA3/5E091078" Ref="#PWR02522"  Part="1" 
F 0 "#PWR02522" H 6570 4870 50  0001 C CNN
...
$EndComp
$Comp
L Custom_Library:GND_USB #PWR02523
U 1 1 5E09107E
P 6570 5320
F 0 "#PWR02523" H 6570 5070 50  0001 C CNN
...
$EndComp
$Comp
L power:+3.3V #PWR02505
U 1 1 5E09109E
P 4420 5020
F 0 "#PWR02505" H 4420 4870 50  0001 C CNN
...
$EndComp
$Comp
L Isolator:TLP185xSE U2503
U 1 1 5E0AA033
P 5500 6100
F 0 "U2503" H 5300 6300 50  0000 L CNN
...
F 4 "TLP185(GB-TPLSECT-ND" H 5500 6100 50  0001 C CNN "Digi-Key PN"
	1    5500 6100
	-1   0    0    -1  
$EndComp
$Comp
...
U 1 1 5E0AC2FC
P 5120 6280
F 0 "#PWR02513" H 5120 6030 50  0001 C CNN
...
AR Path="/5CAD2DA3/5E0ADD6E" Ref="R2503"  Part="1" 
F 0 "R2503" H 5060 5660 50  0000 R CNN
...
U 1 1 5E0AF637
P 5120 5510
F 0 "#PWR02512" H 5120 5360 50  0001 C CNN
...
AR Path="/5CAD2DA3/5E0BA4BC" Ref="#PWR02514"  Part="1" 
F 0 "#PWR02514" H 5880 5360 50  0001 C CNN
...
AR Path="/5CAD2DA3/5E0B8E79" Ref="R2504"  Part="1" 
F 0 "R2504" H 5820 5660 50  0000 R CNN
F 1 "1k" V 5880 5660 50  0000 C CNN
F 2 "Resistors_SMD:R_0603" H 5880 5660 50  0001 C CNN
...
F 7 "RMCF0603FT1K00CT-ND" H 6180 6060 60  0001 C CNN "Digi-Key PN"
	1    5880 5660
	1    0    0    -1  
$EndComp
Wire Wire Line
...
AR Path="/5CAD2DA3/5E1C71F0" Ref="#PWR02524"  Part="1" 
F 0 "#PWR02524" H 6640 5950 50  0001 C CNN
...
$EndComp
$Comp
L Custom_Library:GND_USB #PWR02525
U 1 1 5E1C7C26
P 6640 6300
F 0 "#PWR02525" H 6640 6050 50  0001 C CNN
...
U 1 1 5E4AC84B
P 6640 6200
AR Path="/5CB7A8BC/5E4AC84B" Ref="U?"  Part="1" 
AR Path="/5CAD2DA3/5E4AC84B" Ref="U2504"  Part="1" 
F 0 "U2504" H 6700 6350 50  0000 L CNN
...
F 4 "296-15582-1-ND" H 6640 6200 50  0001 C CNN "Digi-Key PN"
	1    6640 6200
	-1   0    0    -1  
$EndComp
$Comp
L Custom_Library:C_Custom C2506
U 1 1 5E469336
P 7230 5700
F 0 "C2506" H 7255 5800 50  0000 L CNN
F 1 "0.1uF" H 7255 5600 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 7268 5550 50  0001 C CNN
F 3 "" H 7255 5800 50  0001 C CNN
F 4 "0603" H 7080 5800 50  0000 R CNN "display_footprint"
F 5 "50V" H 7080 5700 50  0000 R CNN "Voltage"
F 6 "X7R" H 7080 5600 50  0000 R CNN "Dielectric"
F 7 "311-1344-1-ND" H 7655 6200 60  0001 C CNN "Digi-Key PN"
	1    7230 5700
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5E469340
P 7230 5550
AR Path="/5BAAE1F3/5E469340" Ref="#PWR?"  Part="1" 
AR Path="/5BAAE1DC/5E469340" Ref="#PWR?"  Part="1" 
AR Path="/5CAD2DA3/5E469340" Ref="#PWR02530"  Part="1" 
F 0 "#PWR02530" H 7230 5400 50  0001 C CNN
F 1 "+5V_USB" H 7230 5690 50  0000 C CNN
F 2 "" H 7230 5550 50  0001 C CNN
F 3 "" H 7230 5550 50  0001 C CNN
	1    7230 5550
	1    0    0    -1  
$EndComp
$Comp
L Custom_Library:GND_USB #PWR02531
U 1 1 5E46934A
P 7230 5850
F 0 "#PWR02531" H 7230 5600 50  0001 C CNN
F 1 "GND_USB" H 7230 5700 50  0000 C CNN
